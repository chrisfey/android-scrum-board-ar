package com.zuhlke.tg_mobile.jira_ar_tgmobile.VuforiaUtils;
...
public class VuforiaSession implements Vuforia.UpdateCallbackInterface
{
    ...
    public void resumeAR() throws VuforiaException
    {
        ...
        Vuforia.onResume();
        Log.d(LOGTAG, "resumed all this way");
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "\n");
